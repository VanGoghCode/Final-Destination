          ...
          {!isValid && (
            <p className="text-muted text-sm flex items-center gap-2">
              <span className="inline-flex items-center gap-1">
                {!resumeLatex && <span className="w-2 h-2 rounded-full bg-red-400" />}
                {!jobDescription && <span className="w-2 h-2 rounded-full bg-red-400" />}
                {!companyName && <span className="w-2 h-2 rounded-full bg-red-400" />}
                {!positionTitle && <span className="w-2 h-2 rounded-full bg-red-400" />}
              </span>
