...
/**
 * Cache hook for storing and retrieving data with expiration
 */
...
export function useCache<T>(keyPrefix: string, ttlMs: number = 30 * 60 * 1000) {
  ...
  return { getFromCache, setInCache, removeFromCache, clearCache };
}
